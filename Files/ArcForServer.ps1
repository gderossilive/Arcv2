...
Write-Verbose -Message "Downloading the Arc Agent package" -Verbose -foregroundcolor "yellow"
if ($Proxy) {
...
# Install the package
Write-Verbose -Message "Installing Arc agent" -Verbose -foregroundcolor "yellow"
...
Write-Verbose -Message "Connecting Arc agent to Azure" -Verbose -foregroundcolor "yellow"
if ($AAPLS) {
...
if ($EnableArcAutoupdate=1) {
    Write-Verbose -Message "Enabling Arc Agent autoupdate" -Verbose -foregroundcolor "yellow"
...
if ($EnableSSH=1) {
    ...
    Write-Verbose -Message "Enabling SSH connectivity via Arc" -Verbose -foregroundcolor "yellow"
